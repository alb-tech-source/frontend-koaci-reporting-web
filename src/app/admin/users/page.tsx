...
export default function AdminPenggunaPage() {
  return (
    <ClientGuard requirePermission="users:read:any" fallback={<PageSkeleton />}>
      <UsersPageContent />
    </ClientGuard>
  );
}
...
function UsersPageContent() {
  ...
  const canCreate = hasPermission("users:create:any") || isExecutive;
  const canUpdate = hasPermission("users:update:any") || isExecutive;
  const canDelete = hasPermission("users:delete:any") || isExecutive;
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (response, variables) => {
      ...
      const tempPassword =
        response?.data?.temporaryPassword || "Gagal mendapatkan password";
      setCreatedUser({
                            ...
                            <>
                              ...
                              <Button
                                ...
                                disabled={
                                  ...
                                  toggleMutation.variables?.id === u.id
                                }
                                onClick={() =>
