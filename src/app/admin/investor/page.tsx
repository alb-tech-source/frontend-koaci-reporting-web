...
export default function InvestorPage() {
  return (
    <ClientGuard
      requirePermission="investors:read:any"
...
function InvestorListPage() {
  ...
  const canCreate = hasPermission("investors:create:any");
  const canUpdate = hasPermission("investors:update:any");
  const canDelete = hasPermission("investors:delete:any");
  ...
  return (
    <div className="space-y-6">
                ...
                <TableRow>
                  <TableCell colSpan={hasActions ? 5 : 4} className="h-64">
                    <EmptyStateGeneral
                      ...
                      description="Data investor yang Anda cari tidak ditemukan."
                      icon={Users}
                    />
                  </TableCell>
                </TableRow>
      ...
      <DeleteConfirmDialog
        ...
        description={
          <>
            Yakin ingin menghapus profil investor{" "}
            <span className="font-semibold text-foreground">
              {deleteTarget?.name}
            </span>
            ? Tindakan ini permanen dan akan menghapus semua dokumen yang
            terkait.
          </>
        }
            ...
            <div className="space-y-6 px-6 py-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">
                    {viewing.gender === "men" ? "Laki-laki" : "Perempuan"}
                  </p>
                </div>
                <div>
                  <p className="text-muted-foreground">Tipe Investor</p>
                  <p className="font-medium text-foreground">
                    {viewing.investorType === "individual"
                      ? "Individu"
                      : "Korporasi"}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-semibold text-success text-lg">
                      {formatIDR(viewing.totalInvestasi)}
                    </p>
                  </div>
                </div>
              </div>
