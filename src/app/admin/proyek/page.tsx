...
export default function AdminProyekRoute() {
  return (
    <ClientGuard
      requirePermission="projects:read:any"
...
function ProjectsPage() {
  ...
  const canCreate = hasPermission("projects:create:any");
  const canUpdate = hasPermission("projects:update:any");
  const canDelete = hasPermission("projects:delete:any");
                    ...
                    pageItems.map((p) => {
                      ...
                      return (
                        <TableRow key={p.projectId}>
                          ...
                          <TableCell>
                            <Badge
                              className={cn(projectStatusBadgeClass[p.status])}
                            >
      ...
      <DeleteConfirmDialog
        ...
        description={
          <>
            ...
            ? Tindakan ini permanen, dan seluruh dokumen yang terkait akan
            dihapus.
          </>
        }
        onConfirm={() =>
          deleteTarget && deleteMutation.mutate(deleteTarget.projectId)
        }
